...
today = Data("22 - 6 - 2020")
print(today)
print(Data.valid(22, 6, 2022))
print(today.valid(33, 13, 2222))
print(Data.extract("12 - 9 - 2002"))
print(today.extract("22 - 6 - 2020"))
print(Data.valid(22, 6, 2020))
